...
read -p "Remove old Docker images & rebuild? [Y/n]:"  continuescript
if [[ ${continuescript,,} != "n" ]];then
...
echo "first time login will require migrations to be applied to the SQL Database and you will be prompted during login."
echo "--------------------------------------"
