...
if [[ $continuescript != "n" ]];then
        ...
        echo " Create load balancer:"
                ...
                az network lb probe create --resource-group ossdemo-appdev-iaas --lb-name ossdemo-appdev-iaas-publicLoadBalancer --name HealthProbe80 --protocol tcp --port 80 --interval 15 --threshold 4
