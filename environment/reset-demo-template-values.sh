...
echo ".Editing APP INSIGHTS NODEJSTODO DEMO"
sudo grep -rl VALUEOF-APPLICATION-INSIGHTS-NODEJSTODO-KEY /source/AppDev-ContainerDemo --exclude=$EXCLUDEFILE  | sudo xargs sed -i -e "s@VALUEOF-APPLICATION-INSIGHTS-NODEJSTODO-KEY@$DEMO_APPLICATION_INSIGHTS_NODEJSTODO_KEY@g"
