...
az network vnet subnet create -g ossdemo-appdev-iaas --vnet-name ossdemo-appdev-iaas-vnet \
...
az network lb create -g ossdemo-appdev-iaas -n ossdemo-appdev-iaas-publicLoadBalancer -l eastus \
...
az network lb address-pool create --lb-name ossdemo-appdev-iaas-publicLoadBalancer \
...
az network public-ip create -g ossdemo-appdev-iaas -n svr1-publicIP -l eastus \
...
az network public-ip create -g ossdemo-appdev-iaas -n svr2-publicIP -l eastus \
